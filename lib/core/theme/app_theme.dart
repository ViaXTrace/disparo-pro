  ...
  static ThemeData light() {
    ...
    return ThemeData.light(useMaterial3: true).copyWith(
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        hintStyle: GoogleFonts.dmSans(color: AppColors.textMutedLight),
  ...
  static ThemeData dark() {
    ...
    return ThemeData.dark(useMaterial3: true).copyWith(
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        hintStyle: GoogleFonts.dmSans(color: AppColors.textMutedDark),
        border: OutlineInputBorder(
          borderRadius: BorderRadius.circular(12),
      ...
      chipTheme: ChipThemeData(
        ...
        side: const BorderSide(color: AppColors.borderDark),
        labelStyle: GoogleFonts.dmSans(fontSize: 12, fontWeight: FontWeight.w600, color: AppColors.textSubDark),
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(99)),
        padding: const EdgeInsets.symmetric(horizontal: 4),
      ),
    );
