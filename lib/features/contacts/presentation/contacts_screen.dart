            ...
            sliver: SliverToBoxAdapter(
              child: Row(children: [
                ...
                FilledButton.icon(
                  ...
                  label: Text('Importar', style: GoogleFonts.dmSans(fontSize: 13, fontWeight: FontWeight.w700)),
  ...
  Future<void> _showCreateGroup(BuildContext context, WidgetRef ref) async {
    ...
    final ok = await showDialog<bool>(
      ...
      builder: (_) => AlertDialog(
        title: Text('Novo grupo', style: GoogleFonts.dmSans(fontWeight: FontWeight.w700)),
        ...
        return Expanded(
          child: Container(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Text(g.name, style: GoogleFonts.dmSans(
...
class _ContactRow extends StatelessWidget {
          ...
          child: Row(children: [
            ...
            if (contact.optedOut) ...[
              ...
              Container(
                ...
                child: Text('opt-out', style: GoogleFonts.dmSans(
  ...
  Future<bool?> _confirmDelete(BuildContext context) => showDialog<bool>(
    context: context,
    builder: (_) => AlertDialog(
      title: Text('Remover contato?', style: GoogleFonts.dmSans(fontWeight: FontWeight.w700)),
      content: Text('Esta ação não pode ser desfeita.', style: GoogleFonts.dmSans()),
      actions: [
        TextButton(onPressed: () => Navigator.pop(context, false), child: const Text('Cancelar')),
        FilledButton(
          style: FilledButton.styleFrom(
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Row(children: [
          ...
          Expanded(
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Text(group.name, style: GoogleFonts.dmSans(
                fontSize: 14, fontWeight: FontWeight.w600,
                color: isDark ? AppColors.textDark : AppColors.textLight,
              )),
              const SizedBox(height: 2),
              countAsync.when(
                data: (n) => Text('$n contatos', style: GoogleFonts.dmSans(
                  fontSize: 12,
                  color: isDark ? AppColors.textMutedDark : AppColors.textMutedLight,
                )),
                loading: () => const SizedBox.shrink(),
